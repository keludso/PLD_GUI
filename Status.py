...
class Status_frame:
    def __init__(self,root, x,y, read, write, pressure_read, pressure_write):
        ...
        # Laser
        self.label_las = Label(root, text="LASER", bg="skyblue")
        ...
        # Pressure
        self.label_press = Label(root, text="CHAMBER PRESSURE", bg="skyblue",  font=('Times', 14))
        self.label_press.place(x=x+450,y=y)
        self.press_stat = Label(root, text="1.6e-6",fg="black", bg="yellow", font=('Times', 14))
        self.press_stat.place(x=x+520,y=y+50)
        
        # CAROUSEL1
        self.label_car1 = Label(root, text="CAROUSEL 1", bg="skyblue")
        ...
        # CAROUSEL 2    
        self.label_car2 = Label(root, text="CAROUSEL 2", bg="skyblue")
        self.label_car2.place(x=x+200,y=y+30)
        self.car1_stat = Label(root, text=self.car1_opt[0],fg="white", bg="red")
        self.car1_stat.place(x=x+275,y=y+30)
        
        # TARGET 1
        self.label_tar1 = Label(root, text="TARGET 1", bg="skyblue")
        ...
        # TARGET 2    
        self.label_tar2 = Label(root, text="TARGET 2", bg="skyblue")
        ...
        # Heater    
        self.label_hm = Label(root, text="Heater Motor", bg="skyblue")
        self.tar1_opt =["ACTIVE", "INACTIVE"]
        ...
        self.label_ST = Label(root, text="Substrate Temperature", bg="skyblue")
...
# 
    ...
    def update_parameters(self):
        ...
        # Encoder value 1
        encoder_val1 = int(returnString[1])
        # Encoder value 2
        encoder_val2 = int(returnString[2]) 
        ...
        if (res[0] == '1'):
           ...
           self.tar1_stat.config(text=self.tar1_opt[0],fg="white", bg="green")     

        if (res[1] == '1'):
           self.tar2_stat.config(text=self.tar1_opt[1],fg="white", bg="red")
        else:
           self.tar2_stat.config(text=self.tar1_opt[0],fg="white", bg="green")     

        if (res[2] == '1'):
           self.car1_stat.config(text=self.tar1_opt[1],fg="white", bg="red")
        else:
           self.car1_stat.config(text=self.tar1_opt[0],fg="white", bg="green")   

        if (res[3] == '1'):
           self.car2_stat.config(text=self.tar1_opt[1],fg="white", bg="red")
        else:
           self.car2_stat.config(text=self.tar1_opt[0],fg="white", bg="green")    

        if (res[4] == '1'):
           self.HM_stat.config(text=self.tar1_opt[1],fg="white", bg="red")
        else:
           self.HM_stat.config(text=self.tar1_opt[0],fg="white", bg="green")      
